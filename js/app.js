...
let countdownDate = new Date(2022, 7, 12, 6, 32, 0).getTime();
...
function getCountTime() {
  ...
  const oneDay = 24 * 60 * 60 * 1000; // Сутки * Час * Минута * миллисекунда
  const oneHour = 60 * 60 * 1000; // Час * Минута * миллисекунда
  const oneMinute = 60 * 1000; // Минута * миллисекунда
